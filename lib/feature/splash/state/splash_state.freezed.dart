...
/// @nodoc
mixin _$SplashState {
  SplashStates get splashState => throw _privateConstructorUsedError;
...
abstract class $SplashStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({SplashStates splashState, dynamic isLoading});
}
...
class _$_SplashState extends _SplashState {
  const _$_SplashState(
      {this.splashState = SplashStates.download, this.isLoading = false})
      : super._();

  @override
  @JsonKey()
  final SplashStates splashState;
  @override
  @JsonKey()
  ...
  @override
  String toString() {
    return 'SplashState(splashState: $splashState, isLoading: $isLoading)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, splashState, const DeepCollectionEquality().hash(isLoading));
...
abstract class _SplashState extends SplashState {
  const factory _SplashState(
      {final SplashStates splashState,
      final dynamic isLoading}) = _$_SplashState;
  const _SplashState._() : super._();

  @override
  SplashStates get splashState;
  @override
